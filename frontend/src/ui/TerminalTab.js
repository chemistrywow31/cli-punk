...
import { getTerminalStyle, getTerminalTheme } from '../services/styleSettings.js';
...
export default class TerminalTab {
  ...
  constructor(sessionId) {
    ...
    this._onTerminalStyleChanged = () => this._applyTerminalStyle();
  ...
  dispose() {
    ...
    window.removeEventListener('terminal-style-changed', this._onTerminalStyleChanged);
    if (this._resizeRafId) {
      cancelAnimationFrame(this._resizeRafId);
      this._resizeRafId = null;
    }
